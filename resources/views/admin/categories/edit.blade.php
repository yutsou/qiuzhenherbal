...
@section('content')
    ...
    @endif
    <form class="uk-form-stacked" method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
        @csrf
        <div class="uk-width-1-2">
            <div class="uk-margin">
                ...
                <div class="uk-inline uk-form-controls uk-width-1-1">
                    ...
                    <input type="text" class="uk-input" name="name" value="{{ $category->name }}" required>
                </div>
            </div>
            <div class="uk-margin">
                ...
                <div class="uk-inline uk-form-controls uk-width-1-1">
                    <span class="uk-form-icon" uk-icon="icon: thumbnails"></span>
                    <input type="text" class="uk-input" id="urlName" name="url_name" value="{{ $category->url_name }}" required>
                </div>
            </div>
            <div class="uk-margin">
            ...
            <div class="uk-margin">
                <button type="submit" class="uk-button custom-button-1">修改</button>
            </div>
        </div>
    </form>
@endsection
