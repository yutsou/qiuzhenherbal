                                                ...
                                                <table class="card-body" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                            ...
                                                            <h1 style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="left">{{ $name }}，您好</h1>
                                                            <br>
                                                            <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
                                                                請在30分鐘內點選下面按鈕來重置您的密碼，如果您最近沒有執行這項操作，請忽視這封郵件，並向管理員聯繫。
                                                            </p>
                                                            <br>
                                                            <table class="btn" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important;">
                                                                ...
                                                                <tr>
                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center">
                                                                        <a href="{{ $url }}" style="background-color: #ee782e; color: #fff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; padding: 8px 12px; border: 1px solid transparent;">重置</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
